...
3. 与用户需求直接相关的真实代码入口
4. 如存在对应需求目录，读取 `docs/<需求名>/brief.md`、`docs/<需求名>/acceptance.feature`、`docs/<需求名>/technical_design.md`
...
- 若涉及已完成需求，优先读取 `docs/<需求名>/brief.md`、`docs/<需求名>/technical_design.md`，再用代码校验关键结论。
