...
- `.specs/<需求名>/brief.md` 已冻结
- `.specs/<需求名>/acceptance.feature` 已冻结
- `.specs/<需求名>/technical_design.md` 已审核通过

## 必读

1. `AGENTS.md`
2. `project_info.md`
3. `.specs/<需求名>/feature_info.md`
4. `.specs/<需求名>/brief.md`
5. `.specs/<需求名>/acceptance.feature`
6. `.specs/<需求名>/technical_design.md`
7. 相关真实代码和契约文档
...
- 必要时产出 `.specs/<需求名>/implementation_report.md`
...
以下任一情况必须产出 `.specs/<需求名>/implementation_report.md`：
...
3. 更新 `.specs/<需求名>/feature_info.md`（状态：实现完成）
