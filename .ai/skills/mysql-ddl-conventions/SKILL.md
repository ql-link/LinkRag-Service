...
- `docs/reference/mysql_schema.md`：现有表结构与字段说明
- `docs/db/schema.sql`：当前 DDL 权威来源，新表风格与现有表保持一致
...
1. `docs/db/schema.sql`：追加或更新建表语句
2. `docs/reference/mysql_schema.md`：更新表说明和字段描述
