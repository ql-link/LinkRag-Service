...
CREATE INDEX IF NOT EXISTS idx_parsed_log_original_status
    ON document_parsed_log(document_original_file_id, task_status, updated_at);
CREATE INDEX IF NOT EXISTS idx_parsed_log_parse_file_status
    ON document_parsed_log(document_parse_file_id, task_status, updated_at);
