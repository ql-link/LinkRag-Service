...
CREATE UNIQUE INDEX IF NOT EXISTS uk_parse_task_id ON document_parse_log(task_id);
CREATE INDEX IF NOT EXISTS idx_parse_task_original_status
    ON document_parse_log(document_original_file_id, task_status, updated_at);
CREATE INDEX IF NOT EXISTS idx_parse_task_dataset_user
    ON document_parse_log(dataset_id, user_id, created_at);
CREATE INDEX IF NOT EXISTS idx_parse_task_status_retry
    ON document_parse_log(task_status, dispatch_retry_count, last_dispatched_at);
...
CREATE INDEX IF NOT EXISTS idx_document_parsed_latest_task
    ON document_parsed_file(latest_parse_task_id);
