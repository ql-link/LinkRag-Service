...
5. `docs/module-development-files/<domain>-<module-name>/<phase>/feature_info.md`
...
4. `docs/architecture/middleware_contract.md`（若涉及中间件或跨模块约定）
...
### 10.1 `docs/architecture/middleware_contract.md`
...
### 10.2 `docs/architecture/middleware-components/*.md`
