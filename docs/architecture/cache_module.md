...
## Knowledge file upload runtime config

- Runtime key: `knowledge:file-upload:config`.
- Default source: `tolink.knowledge-file.*`.
...
- `knowledge_file_config` is kept for historical compatibility only and is no longer a runtime config source.
