...
7. `docs/architecture/middleware-components/oss_component.md`
8. `docs/architecture/middleware-components/kafka_component.md`
9. `docs/architecture/middleware-components/redis_component.md`
