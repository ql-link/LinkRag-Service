...
CREATE TABLE IF NOT EXISTS llm_model_config (
    ...
    provider_id         BIGINT UNSIGNED NOT NULL COMMENT '关联 llm_system_provider.id；SYSTEM 固定为 LinkRag，USER 为用户配置厂商',
    provider_type       VARCHAR(32)     NOT NULL COMMENT '厂商类型运行快照；SYSTEM 固定为 linkrag',
